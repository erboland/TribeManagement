    ...
    if (!this.props.isMobile) {
        ...
        <div className="cf main">
          <nav className="fl w-30 mb6 mt3">
            <ul className="list pl4">
              <li className="black f4 pb2 mb3 link dim pa2 pt0 pl0" id="first">
                First Step
              </li>
              <li className="gray f4 pv2 mb3 link dim pa2 pl0" id="second">
                Second Step
              </li>
              <li className="gray f4 pv2 mb3 link dim pa2 pl0" id="third">
                Final Step
              </li>
            </ul>
          </nav>
          <div className="fl w-50">
            <form id="becomeModelForm">
              <div id="firstStep">
                ...
                <p className="f4 gray mb5 lh-copy">
                  Digital photos has to be done with natural light with simple
                  background. Do not send professional photos. Do not pose; do
                  not smile. Keep your hair out of your face. Be natural with no
                  make-up or accessorizes. Wear a swimsuit or tight clothes -
                  neutral color tank top and bottom like legging’s to show
                  easily your body shape.
                </p>

                <input
                  placeholder="First Name"
                  className="pv2 f4 fl mb4"
                  style={{ width: "47.5%" }}
                  id="fn"
                />
                <input
                  placeholder="Last Name"
                  className=" pv2 f4 fr mb4"
                  style={{ width: "47.5%" }}
                  id="ln"
                />
                <input
                ...
                <input
                  ...
                  id="ph"
                  className="w-100 f4 pv2 mb4 mr2"
                />
                <input
                ...
                />
                <p
                  className="black pointer dim flex items-center"
                  id="secondStep"
                  onClick={this.secondStepUpdater}
                >
                  <div id="arrowDown" />
                  <p>Second Step</p>
                </p>
              ...
              <div id="finalStep">
                ...
                />
                <input
                  placeholder="Hips size (cm)"
                  id="hips"
                  className="w-100 f4 pv2 mb4 mr2"
                />
                <input
                  placeholder="Shoes size (cm)"
                  id="shoes"
                  className="w-100 f4 pv2 mb4 mr2"
                />
                <input
              ...
              <div id="thirdStep" className="fl w-100">
                <input
                  placeholder="Headshot straight on"
                  id="hso"
                  className="inputfile"
                  name="hso"
                  type="file"
                  onChange={e => this.setRef("hso", e)}
                />
                <label
                  className="pv2 f4 fl mb5 become_submit pointer mr3 dim gray"
                  id="lhso"
                  style={{ width: "42%" }}
                  for="hso"
                >
                  Headhsot straight on
                </label>
                <input
                  placeholder="Headshot profile"
                  id="hp"
                  name="hp"
                  className=" inputfile"
                  type="file"
                  onChange={e => this.setRef("hp", e)}
                />
                <label
                  className="pv2 f4 fl mb5 become_submit pointer dim gray"
                  id="lhp"
                  style={{ width: "50%" }}
                  for="hp"
                >
                ...
                <input
                  placeholder="Headshot half profile"
                  id="hhp"
                  name="hhp"
                  className="inputfile"
                  type="file"
                  onChange={e => this.setRef("hhp", e)}
                />
                <label
                  className="pv2 f4 fl mb5 become_submit pointer mr3 dim gray"
                  id="lhhp"
                  ...
                  for="hhp"
                >
                  Headhsot half profile
                </label>
                <input
                  placeholder="Full length body shot straight on"
                  id="fbso"
                  name="fbso"
                  className="inputfile"
                  type="file"
                  onChange={e => this.setRef("fbso", e)}
                />
                <label
                  className="pv2 f4 fl mb5 become_submit pointer dim gray"
                  id="lfbso"
                  ...
                  for="fbso"
                >
                  Full length body shot straight on
                </label>
                <input
                  placeholder="Full length body shot profile"
                  id="fbsp"
                  name="fbsp"
                  className="inputfile"
                  type="file"
                  onChange={e => this.setRef("fbsp", e)}
                />
                <label
                  className="pv2 f4 fl mb5 become_submit pointer dim gray"
                  id="lfbsp"
                  ...
                  for="fbsp"
                >
                  Full length body shot profile
                </label>
                <p className="fl w-100">
                  <input
                    className="b ph5 pv3 input-reset ba b--black bg-transparent grow pointer f6 fl w-30"
                    type="submit"
                    value="Send"
                    onClick={this.submitForm}
                  />
                  <p
                    className="gray dim f5 fr w-50 pointer"
                    onClick={this.previousStepUpdater}
                  >
                    Previous Step
                  </p>
                </p>
      ...
      return (
        <div>
          ...
          <p className="gray">
            Digital photos has to be done with natural light with simple
            background. Do not send professional photos. Do not pose; do not
            smile. Keep your hair out of your face. Be natural with no make-up
            or accessorizes. Wear a swimsuit or tight clothes - neutral color
            tank top and bottom like legging’s to show easily your body shape.
          </p>
          <form className="cf" id="becomeModelForm">
            <div id="firstStep" className="cf">
              <p className="f3">Become a model 1/3</p>
              <input
                placeholder="First Name"
                className="pv2 f4 fl mb4 w-100"
                id="fn"
              />
              <input
                placeholder="Last Name"
                className=" pv2 f4 fr mb4 w-100"
                id="ln"
              />
              <input
                placeholder="City"
              ...
              <input
                placeholder="Nationality"
                id="nation"
                className="w-100 f4 pv2 mb2 mr2"
              />
              <p
                className="fr ph3 pv1 ba grow"
                onClick={this.secondStepUpdater}
              >
                Next Step
              </p>
            ...
            <div id="secondStep">
              <p className="f3">Become a model 2/3</p>
              <input
                placeholder="Height (cm)"
                id="height"
                className="w-100 f4 pv2 mb4 mr2"
            ...
            <div id="finalStep">
              <p className="f3">Become a model 3/3</p>
              <input
                placeholder="Headshot straight on"
                id="hso"
                className="inputfile"
              ...
              />
              <label
                className="pv2 f4 fl mb5 become_submit pointer mr3 dim gray w-100"
                id="lhso"
                for="hso"
              >
                Headhsot straight on
              ...
              />
              <label
                className="pv2 f4 fl mb5 become_submit pointer dim gray w-100"
                id="lhp"
                for="hp"
              >
                Headhsot profile
